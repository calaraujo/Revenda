...
namespace Revenda.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await MailHelper.SendMail(model.Email, "Confirmar sua conta", "Confirme sua conta clicando <a href=\"" + callbackUrl + "\">aqui</a>");

                    ViewBag.Message = "Verifique o seu email e confirme a sua conta. O acesso só é permitido após esta confirmação.";
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            if (result.Succeeded)
            {
                UsersHelper.AddUserToRole(userId, "User");
                var user = new User
                {
                    UserName = "",
                    Address = "",
        ...
        public ActionResult CreateUser(User user)
        {
            if (ModelState.IsValid)
            {
                ...
                if (response.Succeeded)
                {
                    ...
                    return View(response.Succeeded ? "ConfirmEmail" : "Error");
                }
                ModelState.AddModelError(string.Empty, response.Message);
            }
            //return View(response.Succeeded ? "ConfirmEmail" : "Error");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await MailHelper.SendMail(model.Email, "Redefinir senha", "Redefina sua senha, clicando <a href=\"" + callbackUrl + "\">aqui</a>");
